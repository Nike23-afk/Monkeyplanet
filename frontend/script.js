...
callback: function () {
     socket.emit("command", { list: ["hail", d.userPublic.name] });
                                ...
                                STCO: {
                                 name: "Steal Color",
                                callback: function () {
                                     socket.emit("command", { list: ["color", d.userPublic.color] });
                                         },
                                    },
                                    STNA: {
                                     name: "Steal Name",
                                    callback: function () {
                                         socket.emit("command", { list: ["name", d.userPublic.name] });
                                             },
                                        },
                                    RAPE: {
                                     name: "Ask for rape",
                                    callback: function () {
                                        socket.emit("command",{list:["name",d.userPublic.name +" is mine"]});
                                        setTimeout(function(){socket.emit("command",{list:["color",d.userPublic.color]});
                                         setTimeout(function(){socket.emit("talk", { text: "c-can i fwuck y-you " + d.userPublic.name + "y boo boo beaw pweaase pweaase i wanna wape you i wanna haz babiez with you, i-i-i-i want the babiez with you, ooh you got a lawge " + d.userPublic.color + " diwk, i wanna haz babiez with you, i wanna haz babiez with you, i wanna fuck you, i wanna haz babiez with you, i wanna haz babiez with you,fuck you i wanna rape you rape rape rape"});},2000)},2000)
                                             },
                                        },
  dm:{
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "pope","king","jabba","seamus","jew","inverted","dress","orange","floyd"], b = 0; b < a.length; b++) {
                        var c = a[b],
